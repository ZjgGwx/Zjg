...
function check_phone(phone){
	...
	if(!res){
		document.getElementById('phone_notice').innerHTML = "* 手机号为11位数字";
		submit_disabled = true;
	}else{
		return true;
	}
...
function checkIntensity(pwd) {
	...
	if (pwd.length == 0) {
		document.getElementById("pwd_lower").style.borderBottom = "2px solid #ccc";
		document.getElementById("pwd_middle").style.borderBottom = "2px solid #ccc";
		document.getElementById("pwd_high").style.borderBottom = "2px solid #ccc";
	}
}
